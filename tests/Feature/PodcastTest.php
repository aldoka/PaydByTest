...
class PodcastTest extends TestCase
{
     ...
     * @return array
     */
    public function publishedAndReviewPodcasts() : array
    {
        ...
        return [
            'published podcast' => [$publishedPodcast],
            'review podcast' => [$reviewPodcast],
        ];
    }
    ...
    /**
     * @dataProvider publishedAndReviewPodcasts
     */
    public function testDeleteDestroySuccess($podcast): void
    {
        $response = $this->deleteJson(self::DELETE_ITEM . '/' . $podcast->id, [], self::CORRECT_HEADERS);
